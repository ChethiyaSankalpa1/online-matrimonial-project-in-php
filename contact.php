...
<div class="banner">
    <p class="banner-text">Contact Us - Help & Support - 24x7 Live help.</p>
</div>
...
<div class="contact-container">
    <div class="social-header">
        ...
        <p class="info-text">or please enter your information below. One of our administrators will reply within 24-48 hours (Mon-Fri).</p>
    </div>
        ...
        <div class="form-inner">
            <form method="POST" action="process_contact.php">
                ...
                <div class="form-group">
                    ...
                    <textarea name="comments" class="form-textarea" placeholder="Please tell us how we can help" required></textarea>
                </div>
